...
const Landing = () => {
  ...
  return (
    <div className="tracking-normal text-indigo-400 m-6 bg-cover bg-fixed mt-10">
      <div className="container mx-auto max-w-7xl px-2 mt-6 sm:px-6 lg:px-8 flex flex-wrap items-center">
        <div className="flex flex-col w-full md:w-1/2 justify-center lg:items-start overflow-y-hidden">
          <h1 className="my-4 text-5xl md:text-5xl xl:text-7xl text-white opacity-75 font-bold leading-tight text-center md:text-left">
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-blue-300 to-green-400">
              TaskBruin
            </span>
          </h1>
